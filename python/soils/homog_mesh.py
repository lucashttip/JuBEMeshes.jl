...
def make_soil_foundation_layer(a=1.0,fl=2.0,fs=10.0, z = 0.0,nf=18,ns = 9, inverse = False):
...
def make_mesh_soil_foundation(a=1.0, fl=2.0, fs=10.0, nf=18, ns = 9, popup=False):
    gmsh.initialize()
    ...
    s1,s2,s3,s4,s5 = make_soil_foundation_layer(a=a,fl=fl,fs=fs,nf=nf,ns = 9, z = 0.0)
...
def make_mesh_soil_foundation_rock(a=1.0, fl=2.0, fs=10.0, nf1=18, nf2 = 9, z = 1.0,inverse = True, popup=False):
    gmsh.initialize()
    ...
    s1,s2,s3,s4,s5 = make_soil_foundation_layer(a=a,fl=fl,fs=fs,nf=nf1,inverse = inverse, z = 0.0)
    s6,s7,s8,s9,s10 = make_soil_foundation_layer(a=a,fl=fl,fs=fs,nf=nf2, z = z)
    ...
    pr = gmsh.model.addPhysicalGroup(2, [s6, s7, s8, s9, s10])
...
def make_mesh_soil_foundation_rock2(a=1.0, fl=2.0, fs=10.0, nf1=18, nf2 = 9, z = 1.0, inverse = True, popup=False):
    gmsh.initialize()
    ...
    s1,s2,s3,s4,s5 = make_soil_foundation_layer(a=a,fl=fl,fs=fs,nf=nf1, z = 0.0, inverse = inverse)
    s6 = make_square(l=a*fs, z1 = z, z2 = z, nf = nf2)
    ...
    pr = gmsh.model.addPhysicalGroup(2, [s6])
    gmsh.model.setPhysicalName(2, pr, "u 0.0 0.0 0.0")
